...
- 3-a → ⚠️未修复（无 feature gate；supportInterruption 恒 true 零影响）
- 3-b → ⚠️未修复（feature 闸门未移植，lib 无 AppFeatureUtils）
- 3-c → ✅已修复（60bd048）
- 3-d → ✅已修复（60bd048）
- 3-e → ✅已修复（60bd048）
- 3-f → ⚠️未修复（纯遗留常量缺失，零影响）
- 4.1-1 → ✅已修复（60bd048）
- 4.1-2 → ⚠️半修（条件更新已 60bd048；闸门恒 true 零影响）
- 4.1-3 → ✅已修复（60bd048）
- 4.1-4 → ⚠️未修复（feature flag 不存在）
- 4.1-5 → ⚠️未修复（恒 true，零影响）
- 4.1-6 → ⚠️待复核（单测是否补未确认）
- 4.1-7 → ⚠️未修复（纯遗留，零影响）
- 4.2-1 → ✔️保持简化
- 4.2-2 → ✔️保持简化
